    ...
    function initAnime() {
        ...
        function buildUrl(params) {
            ...
            if (params.season) {
                ...
                base += '&first_air_date.gte=' + d.start + '&first_air_date.lte=' + d.end;
            }
            if (params.genre) base += '&with_genres=' + params.genre;
            base += '&sort_by=' + (params.sort || 'popularity.desc');
            return base;
        }
            ...
            Lampa.Activity.push({
                ...
                categories: [
                    ...
                    },
                    {
                        ...
                        url: buildUrl({ status: '0' }),
                        component: 'category_full'
                    },
                    {
                        title: 'Завершенные',
                        url: buildUrl({ status: '3' }),
                        component: 'category_full'
                    },
                    {
                        title: 'Зима 2024',
